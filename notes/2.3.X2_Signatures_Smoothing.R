...
=======
# fc_mat = reshape2::dcast(gxdiff, feature_id ~ comparison, value.var = "estimate")
# fc_mat = column_to_rownames(fc_mat, var = "feature_id")
# fc_mat = as.matrix(fc_mat)
>>>>>>> Stashed changes
...
=======
# fc_mat_ep = reshape2::dcast(gxdiff, feature_id ~ comparison, value.var = "estimate_logp")
# fc_mat_ep = column_to_rownames(fc_mat_ep, var = "feature_id")
# fc_mat_ep = as.matrix(fc_mat_ep)
>>>>>>> Stashed changes
...
# -----------------------------------
# wf-721f0038f4 - ARCHS - pValue
# wf-c3495897d7 - STRING - pValue
...
nameChange = function(X2_Smoothed, suffix, insilico = F) {
  lapply(X2_Smoothed, function(x) {
    ...
    signatureNames = signatureNames %>%
      ...
      str_replace("inhibited_vs_activated","x2_inhibition") %>%
...
# ------------------------
X2_Smoothed = extract_signatures("wf-721f0038f4", gxdiff = T, extract_top_50 = T)
pushToCC(X2_Smoothed, tagsToPass = list(list(name = "object",value="X2_smoothed_signatures_withAlphas")))
# wf-34e747bb2d
# wf-bbe7e163a2
...
# ------------------------
X2_Smoothed = extract_signatures("wf-c3495897d7", gxdiff = T, extract_top_50 = T)
pushToCC(X2_Smoothed, tagsToPass = list(list(name = "object",value="X2_smoothed_signatures_withAlphas")))
# wf-34e747bb2d
# wf-4a3e0c83f9
...
=======
all = rbind(archs_p, string_p, insilico_archs, insilico_string, tryptase_archs)
>>>>>>> Stashed changes
